...
*(Bagian ini menyediakan area bagi Anda untuk menempelkan foto tangkapan layar antarmuka aplikasi atau gambar mockup ke dalam dokumen Microsoft Word).*

#### 1. Mockup Halaman Kasir POS Utama (*POS Cashier Screen*)
Tampilan kasir memuat filter kategori menu, katalog kartu produk dengan foto dan harga, daftar keranjang belanja, serta pilihan metode pembayaran.

```
+-------------------------------------------------------------------------+
|                                                                         |
|                [ TEMPELKAN GAMBAR MOCKUP KASIR POS DI SINI ]            |
|                                                                         |
|  (File tersedia di: public/mockups/pos_cashier_mockup.jpg)              |
|                                                                         |
+-------------------------------------------------------------------------+
```
*Gambar 1: Desain Antarmuka Terminal Kasir Utama (Cafe RJ POS)*

---

#### 2. Mockup Halaman Dashboard dan Master Menu (*Admin View*)
Tampilan panel admin memuat ringkasan kartu metrik (Total Penjualan, Total Transaksi, Menu Terlaris, Stok Menipis) dan tabel CRUD master produk.

```
+-------------------------------------------------------------------------+
|                                                                         |
|             [ TEMPELKAN GAMBAR MOCKUP DASHBOARD ADMIN DI SINI ]         |
|                                                                         |
|  (File tersedia di: public/mockups/admin_dashboard_mockup.jpg)          |
|                                                                         |
+-------------------------------------------------------------------------+
```
*Gambar 2: Desain Antarmuka Panel Admin dan Manajemen Menu*

---

#### 3. Mockup Tampilan Modal QRIS / Layar Pelanggan
Tampilan pop-up pembesar kode QRIS agar pelanggan mudah memindai barcode dari meja kasir.

```
+-------------------------------------------------------------------------+
|                                                                         |
|             [ TEMPELKAN SCREENSHOT TAMPILAN MODAL QRIS DI SINI ]        |
|                                                                         |
+-------------------------------------------------------------------------+
```
*Gambar 3: Desain Tampilan Modal Perbesar QRIS Pelanggan*

---

#### 4. Mockup Tampilan Cetak Struk Belanja (*Receipt Invoice*)
Tampilan bukti transaksi siap cetak dengan pilihan mode Faktur Layar Penuh (A4) dan mode Struk Mini Thermal (80mm).

```
+-------------------------------------------------------------------------+
|                                                                         |
|           [ TEMPELKAN SCREENSHOT HASIL CETAK STRUK DI SINI ]            |
|                                                                         |
+-------------------------------------------------------------------------+
```
*Gambar 4: Desain Format Cetak Struk Belanja Transaksi*
